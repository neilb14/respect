...
app.get("/respect/feature/:feature.:format?", function(req, res) {
	...
	console.log('== is Running: ' + jasmineEnv.currentRunner().queue.running);
	console.log('== description: ' + jasmineEnv.currentRunner().specs()[0].description);
	respond('spec.jade', req, res, {title:settings.title, feature:req.params.feature, runUrl:'/respect/feature/' + req.params.feature});
});
